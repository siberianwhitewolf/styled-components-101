...
const StyledShopByCharacter = styled.div`
  display: flex;
  flex-direction: column;
  width: 100vw;
  align-items: center;
...
const StyledShopByCharacterLink = styled.a`
  text-decoration: none;
  @media only screen and (max-width: 1300px) {
    margin: 10px;
  }
...
const Home = () => {
  ...
  return (
    <Body>
      ...
      <HorizontalRule />
      <StyledShopByCharacter>
        <StyledNewReleasesTopContainer>
          <StyledTitleBig>Shop by character</StyledTitleBig>
        </StyledNewReleasesTopContainer>
        <StyledCharacterContainer>
          <StyledShopByCharacterRowContainer>
            <StyledShopByCharacterLink href="https://www.nintendo.com/games/game-guide/#filter/:q=&dFR[franchises][0]=Mario">
            ...
            </StyledShopByCharacterLink>
            <StyledShopByCharacterLink href="https://www.nintendo.com/games/game-guide/#filter/:q=&dFR[franchises][0]=Zelda">
              <StyledShopByCharacterContainer>
                <StyledCharacterImage
          ...
          <StyledShopByCharacterRowContainer>
            <StyledShopByCharacterLink href="https://www.nintendo.com/games/game-guide/#filter/:q=&dFR[franchises][0]=Animal%20Crossing">
              <StyledShopByCharacterContainer>
                <StyledCharacterImage
            ...
            <StyledShopByCharacterLink href="https://www.nintendo.com/games/game-guide/#filter/:q=&dFR[franchises][0]=Kirby">
              <StyledShopByCharacterContainer>
                <StyledCharacterImage
      ...
      <StyledFooterBottom>
        <StyledBottomElementsContainer>
          ...
          <StyledLinkContainer>
            <a href="https://www.facebook.com/Nintendo/">
            ...
            <a href="https://www.instagram.com/nintendo/">
              <StyledSocialNetworkButton
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
            ...
            <a href="https://twitter.com/NintendoAmerica">
              <StyledSocialNetworkButton
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
            ...
            <a href="https://www.youtube.com/nintendo">
              <StyledSocialNetworkButton
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
          ...
          <StyledLinkContainer>
            ...
            <StyledSmallSupportLink href="https://en-americas-support.nintendo.com/">
              {" "}
              Support
            </StyledSmallSupportLink>
          </StyledLinkContainer>
        </StyledBottomElementsContainer>
      </StyledFooterBottom>
    </Body>
